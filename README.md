...
| `/api/waitlist` | Same-origin waitlist API. Vite preview/dev writes JSONL (`WAITLIST_FILE` or `./data/waitlist.jsonl`). Production Cloudflare Worker accepts the same payload at `/api/waitlist`. |
