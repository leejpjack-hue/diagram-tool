import CJS_COMPAT_NODE_URL_t3zrolfczbl from 'node:url';
import CJS_COMPAT_NODE_PATH_t3zrolfczbl from 'node:path';
import CJS_COMPAT_NODE_MODULE_t3zrolfczbl from "node:module";

var __filename = CJS_COMPAT_NODE_URL_t3zrolfczbl.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_t3zrolfczbl.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_t3zrolfczbl.createRequire(import.meta.url);
...
var core = {
  ...
  if (reactDocgenOption === "react-docgen-typescript" && typescriptPresent && plugins.push(
    ...
    let { reactDocgen } = await import("./_node-chunks/react-docgen-6HXZFUKP.js");
    plugins.unshift(
