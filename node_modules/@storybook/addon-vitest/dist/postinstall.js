import CJS_COMPAT_NODE_URL_00n11sm5umzgk from 'node:url';
import CJS_COMPAT_NODE_PATH_00n11sm5umzgk from 'node:path';
import CJS_COMPAT_NODE_MODULE_00n11sm5umzgk from "node:module";

var __filename = CJS_COMPAT_NODE_URL_00n11sm5umzgk.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_00n11sm5umzgk.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_00n11sm5umzgk.createRequire(import.meta.url);
...
import {
  any
} from "./_node-chunks/chunk-REXKW6AX.js";
import {
  DOCUMENTATION_LINK
} from "./_node-chunks/chunk-DFNGCCLX.js";
import {
  require_dist
} from "./_node-chunks/chunk-TYP3PSDO.js";
import {
  dirname,
  normalize,
  relative,
  resolve
} from "./_node-chunks/chunk-UX2ERTAZ.js";
import {
  require_compare,
  require_constants,
  require_debug,
  ...
  require_re,
  require_semver
} from "./_node-chunks/chunk-F4RKYDI5.js";
import {
  __commonJS,
  __toESM
} from "./_node-chunks/chunk-4FUJIIL4.js";
...
async function getTemplatePath(name) {
  switch (name) {
    case "vitest.config.template":
      return import("./_node-chunks/vitest.config-GKAEB3MW.js");
    case "vitest.config.4.template":
      return import("./_node-chunks/vitest.config.4-RVCPOKG2.js");
    case "vitest.config.3.2.template":
      return import("./_node-chunks/vitest.config.3.2-3YRUQTRJ.js");
    case "vitest.workspace.template":
      return import("./_node-chunks/vitest.workspace-X6FMKKV2.js");
    default:
