import CJS_COMPAT_NODE_URL_1iymwr7joh9 from 'node:url';
import CJS_COMPAT_NODE_PATH_1iymwr7joh9 from 'node:path';
import CJS_COMPAT_NODE_MODULE_1iymwr7joh9 from "node:module";

var __filename = CJS_COMPAT_NODE_URL_1iymwr7joh9.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_1iymwr7joh9.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_1iymwr7joh9.createRequire(import.meta.url);
        ...
        suggest: [
          {
            ...
            *fix(fixer) {
              let suffix = context.sourceCode.text.slice(id.range[0], id.range[1]).substring(name.length), pascal = toPascalCase(name);
