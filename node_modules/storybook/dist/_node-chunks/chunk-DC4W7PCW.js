...
import {
  ...
  invariant,
  up2 as up
} from "./chunk-S447H5QO.js";
import {
  resolvePackageDir
} from "./chunk-3CFMGL7P.js";
import {
  require_dist
} from "./chunk-J3D4UFKB.js";
import {
  babelParse,
  recast,
  traverse,
  types
} from "./chunk-RSPUQ3GT.js";
import {
  require_picocolors
} from "./chunk-42F4BXGV.js";
import {
  __commonJS,
  __require,
  __toESM
} from "./chunk-4BS6LSRK.js";
...
var configureFlatConfig = async (code) => {
  let ast = babelParse(code), tsEslintLocalName = "", eslintDefineConfigLocalName = "", eslintConfigExpression = null;
  return traverse(ast, {
...
var AddonVitestService = class {
  ...
  isValidVitestConfig(configContent) {
    ...
    return babel.traverse(parsedConfig, {
      ExportDefaultDeclaration: (path2) => {
        this.isDefineConfigExpression(path2.node.declaration) ? isValidVitestConfig = this.isSafeToExtendWorkspace(path2.node.declaration) : this.isMergeConfigExpression(path2.node.declaration) && (isValidVitestConfig = path2.node.declaration.arguments.some(
  ...
  isSafeToExtendWorkspace(node) {
    ...
    return babel.types.isCallExpression(node) ? node.arguments.length > 0 && babel.types.isObjectExpression(node.arguments[0]) && (objectToValidate = node.arguments[0]) : babel.types.isObjectExpression(node) && (objectToValidate = node), objectToValidate ? objectToValidate.properties.every(
