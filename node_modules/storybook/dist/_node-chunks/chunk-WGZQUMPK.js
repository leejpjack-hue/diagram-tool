...
import {
  require_build
} from "./chunk-EQ54US4S.js";
import {
  StorybookError
} from "./chunk-DGG37MUT.js";
import {
  up
...
var getComponentVariableName = async (name) => (await import("./camelcase-WT2C5B2O.js")).default(name.replace(/^[^a-zA-Z_$]*/, ""), { pascalCase: !0 }).replace(/[^a-zA-Z_$]+/, "");
